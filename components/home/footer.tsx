...
const shopLinks = [
  ...
  { label: "Sofas & Couches", href: "/shop/sofas" },
    ...
    <footer className="bg-background">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10">
          ...
          <div className="flex flex-col gap-4">
            <span className="text-sm font-semibold text-foreground">Customer Service</span>
            <ul className="flex flex-col gap-2.5">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2.5">
              <a
                href="mailto:hello@naturafurniture.com"
                className="text-sm text-muted-foreground hover:text-foreground transition-colors"
              >
                hello@naturafurniture.com
              </a>
              <a
                href="tel:+18003234567"
                className="text-sm text-muted-foreground hover:text-foreground transition-colors"
              >
                +1 (800) 323-4567
              </a>
        ...
        <div className="border-t border-border mt-12 pt-6 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Natura Furniture. All rights reserved.
          </p>
          <p className="text-xs text-muted-foreground">
